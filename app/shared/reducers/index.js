...
export const reducers = combineReducers({
  ...
  tipoOperacaos: require('../../modules/entities/tipo-operacao/tipo-operacao.reducer').reducer,
  parametrizacaos: require('../../modules/entities/parametrizacao/parametrizacao.reducer').reducer,
  contasPagarRecebers: require('../../modules/entities/contas-pagar-receber/contas-pagar-receber.reducer').reducer,
  comunicacaoPushes: require('../../modules/entities/comunicacao-push/comunicacao-push.reducer').reducer,
  comunicacaoPushLojas: require('../../modules/entities/comunicacao-push-loja/comunicacao-push-loja.reducer').reducer,
