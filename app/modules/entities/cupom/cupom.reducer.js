...
// successful api lookup for single entity user
export const userSuccess = (state, action) => {
  const { cupomUser } = action
  return state.merge({
    fetchingOne: false,
    errorOne: null,
    cupomUser
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.CUPOM_USER_FAILURE]: userFailure,
