...
import styles from './agenda-eventos-entity-screen-style'
...
class AgendaEventoEntityScreen extends React.PureComponent {
  ...
  navigationButtonPressed ({ buttonId }) {
    agendaEventoEntityEditScreen({ entityId: null })
  }
  /* ***********************************************************
  * STEP 2
  ...
  *************************************************************/
  renderRow ({item}) {
    return (
      <TouchableOpacity onPress={agendaEventoEntityDetailScreen.bind(this, { entityId: item.id })}>
  ...
  *************************************************************/
  ...
  renderEmpty = () =>
    <AlertMessage title='No AgendaEventos Found' show={!this.props.fetching} />
  ...
  render () {
    return (
      <View style={styles.container} testID='agendaEventoScreen'>
        <FlatList
